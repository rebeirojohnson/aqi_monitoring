...
import os
from preprocess import training_array, output_array, x_train, x_test, y_train, y_test,training_dataset,training_df,output_df
...
# Fitting the model
mlr_model.fit(training_df,output_df)
